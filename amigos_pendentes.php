			...
			<div class="pedidos">
				<ul style="list-style: none;">
					<?php 
						...
						$sql_amigos = "SELECT * FROM relacionamentos WHERE amigo2 = '$usuario_da_pagina' AND status = 'P'";	
						...
						if($busca_bd_amigos){
							while($dados_amigos = mysqli_fetch_array($busca_bd_amigos)){
								$nome_usuario = $dados_amigos['amigo1'];
								...
								if($busca_bd_fotos_usuario){
									...
									echo "<form method='post' action='formularios/aceita_amigo.php'>";
									...
									echo "<a href='minha_lista.php'><button class='btn-lista add-amigo btn-aceita'>Aceitar Pedido de Amizade</button></a>";
									echo "</form>";
									echo "<form method='post' action='formularios/nega_amigo.php'>";
									echo "<input style='display: none;' type='text' name='manda' value='" . $usuario_da_pagina . "'>";
									echo "<input style='display: none;' type='text' name='recebe' value='" . $dados_fotos_usuario['usuario'] . "'>";
									echo "<a href='minha_lista.php'><button class='btn-lista add-amigo btn-recusa'>Recusar Pedido de Amizade</button></a>";
									echo "</form>";
									echo "</li>";
								}
						...
						if ($numero_vezes == 0) {
							echo "<div class='col-md-12'><p>Você Não tem Pedidos de Amizade Pendentes</p></div>";
						}
